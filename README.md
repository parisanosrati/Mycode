...
services:
  traefik:
    ...
    command:
      ...
      - "--certificatesresolvers.mycert.acme.email=nosrati.net@gmail.com"
    ...
    labels:
      ...
      - "traefik.http.routers.traefik.rule=Host(`web.parisanosrati.ir`)"
      - "traefik.http.routers.traefik.middlewares=https-redirect"
      - "traefik.http.middlewares.https-redirect.redirectscheme.scheme=https"
      - "traefik.http.middlewares.web-auth.basicauth.users=parisa:{SHA}Pn2838"
      - "traefik.http.routers.traefik-secure.middlewares=web-auth"
      - "traefik.http.routers.traefik-secure.entrypoints=https"
      - "traefik.http.routers.traefik-secure.rule=Host(`web.parisanosrati.ir`)"
